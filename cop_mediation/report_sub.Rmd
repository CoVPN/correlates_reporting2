...
full_result <- rbind(bind_result, adcp_result)
...
knitr::kable(summary_stats$tab1, caption = "Endpoints included in phase 2 by study arm, binding analysis")
knitr::kable(summary_stats$tab2, caption = "Total endpoints by study arm, binding analysis")
knitr::kable(summary_stats$tab1, caption = "Endpoints included in phase 2 by study arm, ADCP analysis")
knitr::kable(summary_stats$tab2, caption = "Total endpoints by study arm, ADCP analysis")
```