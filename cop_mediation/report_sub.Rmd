...
}else if(COR == "D29IncludeNotMolecConfirmed"){
  info <- paste0(
    "Day 29 analysis including non-molecularly confirmed endpoints starting ",
    "one day after first dose."
  )
}
if(full_config_name == "janssen_pooled_real"){
  title <- "Binding Assays"
}else if(full_config_name == "janssen_pooled_realADCP"){
  title <- "ADCP"
}
```
...
full_result <- readRDS(here::here("output",
  paste0("full_result_", full_config_name, "_", COR, ".rds")
)
