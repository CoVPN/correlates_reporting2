...
CoR_D1 <- function(dt, density,
                   ...
                   dir_name, 
                   x_range = c(-0.02, 0.17),
                   x_break = c(0, 0.03, 0.06, 0.09, 0.12, 0.15),
                   save_pdf = TRUE){
...
################################################################################
# FS markers
mk_primary_list = c('Bcd4_FS_BA.4.5.S', 
                    'Day15cd4_FS_BA.4.5.S',
                    'Bcd4_FS_Wuhan.N')
mk_primary_names_list = c('D1 % CD4+ Functionality Score Spike BA.4/5',
                          'D15 % CD4+ Functionality Score Spike BA.4/5',
                          'D1 % CD4+ Functionality Score N Index')
