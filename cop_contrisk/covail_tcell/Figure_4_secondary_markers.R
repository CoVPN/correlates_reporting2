...
CoR_D1 <- function(dt, density,
                   ...
                   dir_name, x_range = c(0.001, 1),
                   x_break = c(0.001, 0.01, 0.1, 1),
                   save_pdf = TRUE){
...
CoR_primary_analysis <- function(dt, mk_secondary_list,
                                 mk_secondary_names_list,
                                 arm_name = 'TrtonedosemRNA',
                                 title_name = 'Controlled risk among one-dose mRNA vaccinees',
                                 six_month_only = FALSE,
                                 naive_only = FALSE){
  for (i in 1:length(mk_secondary_list)){
    var_name = mk_secondary_list[i]
    mk_nm = mk_secondary_names_list[i]
...
mk_secondary_list = c(
                    ...
                    'Bcd4_IFNg.IL2.154_Wuhan.N',
                    'Bcd4_IFNg.IL2.154_BA.4.5.S'
                    )
                    
mk_secondary_names_list = c(
                          'D15 % CD8+ T cell expressing IFNg \nand/or IL-2 against Spike BA.4/5',
                          'D15 % CD4+ T cell expressing IFNg and/or IL-2 \nand/or CD154 against Spike BA.4/5',
                          'D15 % CD4+ T cell expressing IL-21 \nagainst Spike BA.4/5',
                          'D1 % CD8+ T cell expressing IFNg \nand/or IL-2 against Spike BA.4/5',
                          'D1 % CD4+ T cell expressing IFNg and/or IL-2 \nand/or CD154 against Index N',
                          'D1 % CD4+ T cell expressing IFNg and/or IL-2 \nand/or CD154 against Spike BA.4/5'
                           ) 
...
CoR_primary_analysis(dt = dt_PP_onedosemRNA,
                     mk_secondary_list = mk_secondary_list,
                     mk_secondary_names_list = mk_secondary_names_list,
                     title_name = 'Controlled risk among one-dose mRNA vaccinees',
                     arm_name = 'TrtonedosemRNA')
