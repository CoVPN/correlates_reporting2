...
SLperf_allvarsets <- read.csv(here("cor_surrogates", "output", "DiscreteSLperformance_allvarsets.csv"), 
                              row.names = 1,
                              header = TRUE)  %>%
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[29], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting COVID-19 disease status starting 7 days after ", day)}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", levels(SLperf_allvarsets$varset)[29], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[30], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting COVID-19 disease status starting 7 days after ", day)}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", levels(SLperf_allvarsets$varset)[30], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[31], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting COVID-19 disease status starting 7 days after ", day)}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", levels(SLperf_allvarsets$varset)[31], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[32], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting COVID-19 disease status starting 7 days after ", day)}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", levels(SLperf_allvarsets$varset)[32], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[33], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting COVID-19 disease status starting 7 days after ", day)}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", levels(SLperf_allvarsets$varset)[33], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[34], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting COVID-19 disease status starting 7 days after ", day)}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", levels(SLperf_allvarsets$varset)[34], ".png")))
```
