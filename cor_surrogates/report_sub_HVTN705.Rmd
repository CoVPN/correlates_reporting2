...
\clearpage
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[16], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[16], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[17], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[17], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[18], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[18], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[19], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[19], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[20], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[20], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[21], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[21], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[22], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[22], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[23], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[23], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[24], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[24], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[25], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[25], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[26], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[26], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[27], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[27], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[28], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[28], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[29], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[29], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[29], "'': Weighted CV-AUC ROC curves of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("ROCcurve_", levels(SLperf_allvarsets$varset)[29], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[29], "'': Weighted prediction probability plots of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("predProb_", levels(SLperf_allvarsets$varset)[29], ".png")))
```

```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[30], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[30], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[30], "'': Weighted CV-AUC ROC curves of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("ROCcurve_", levels(SLperf_allvarsets$varset)[30], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[30], "'': Weighted prediction probability plots of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("predProb_", levels(SLperf_allvarsets$varset)[30], ".png")))
```

\clearpage
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[31], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[31], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[31], "'': Weighted CV-AUC ROC curves of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("ROCcurve_", levels(SLperf_allvarsets$varset)[31], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[31], "'': Weighted prediction probability plots of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("predProb_", levels(SLperf_allvarsets$varset)[31], ".png")))
```

```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[32], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[32], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[32], "'': Weighted CV-AUC ROC curves of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("ROCcurve_", levels(SLperf_allvarsets$varset)[32], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[32], "'': Weighted prediction probability plots of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("predProb_", levels(SLperf_allvarsets$varset)[32], ".png")))
```

```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[33], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[33], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[33], "'': Weighted CV-AUC ROC curves of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("ROCcurve_", levels(SLperf_allvarsets$varset)[33], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[33], "'': Weighted prediction probability plots of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("predProb_", levels(SLperf_allvarsets$varset)[33], ".png")))
```

```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[34], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[34], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[34], "'': Weighted CV-AUC ROC curves of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("ROCcurve_", levels(SLperf_allvarsets$varset)[34], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[34], "'': Weighted prediction probability plots of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("predProb_", levels(SLperf_allvarsets$varset)[34], ".png")))
```

```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[35], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[35], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[35], "'': Weighted CV-AUC ROC curves of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("ROCcurve_", levels(SLperf_allvarsets$varset)[35], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[35], "'': Weighted prediction probability plots of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("predProb_", levels(SLperf_allvarsets$varset)[35], ".png")))
```

```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", SLperf_allvarsets$varsetStr[36], "'': Weighted CV-AUC (95\\% CI) of algorithms for predicting HIV disease status after ", day, ". Dashed vertical line drawn at CV-AUC = 0.5 represents performance similar to random chance.")}
 knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("forest_vacc_cvaucs_", SLperf_allvarsets$varset[36], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[36], "'': Weighted CV-AUC ROC curves of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("ROCcurve_", levels(SLperf_allvarsets$varset)[36], ".png")))
```
...
```{r, echo=FALSE, out.width="99%", out.height="120%", fig.cap=paste0("Variable set ``", levels(SLperf_allvarsets$varsetStr)[36], "'': Weighted prediction probability plots of top two individual learners along with Super Learner and discrete-SL.")}
           knitr::include_graphics(here::here("cor_surrogates", "figs", paste0("predProb_", levels(SLperf_allvarsets$varset)[36], ".png")))
```
