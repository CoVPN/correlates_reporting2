...
`r if (!exists("has.scaled")) has.scaled=T`
`r if (!exists("show.sample.size")) show.sample.size=T`
...
\\caption{Forest plots depicting hazard ratios per 10-fold change in marker, x-axis on the antilog scale.}
\\end{figure}
", sep="")
...
\\caption{Forest plots depicting hazard ratios per 10-fold change in marker, x-axis on the log scale.}
\\end{figure}
", sep="")
...
\\caption{Forest plots depicting hazard ratios per SD change in marker, x-aix on the antilog scale.}
\\end{figure}
", sep="")
...
\\caption{Forest plots depicting hazard ratios per SD change in marker, x-aix on the log scale.}
\\end{figure}
", sep="")
