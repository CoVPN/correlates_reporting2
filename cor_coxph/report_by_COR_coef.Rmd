...
Each row represents results from one model with a single immune biomarker. The first table shows HRs per x-fold increase (unless otherwise noted) and the second table shows HRs per SD increase. 
