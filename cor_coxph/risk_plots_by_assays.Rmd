...
\center
  ...
  [width=.48\textwidth,keepaspectratio]{`r paste0(pathCoRoutput, "/", a, "_")`marginalized_risks_eq_`r if(!has.plac) "woplacebo_"``r fname.suffix`.pdf}}
\caption{Marginalized cumulative risk curves (=s). Case counting starts `r tpeaklag` days post Day `r tpeak`.}
\end{figure}
\clearpage
...
\caption{Controlled VE curves (=s). Case counting starts `r tpeaklag` days post Day `r tpeak`.}
\end{figure}
\clearpage
