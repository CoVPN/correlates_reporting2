...
\center
  ...
  [width=.48\textwidth,keepaspectratio]{`r paste0(pathCoRoutput, "/", a, "_")`marginalized_risks_cat_`r fname.suffix`.pdf}}
  \hspace{10pt}
  \subfloat[][Marginalized cumulative risk as functions of Day `r tpeak` markers (=s) among vaccine recipients with 95\% bootstrap point-wise confidence bands (\protect\input{`r pathCoRoutput`/bootstrap_replicates} replicates). The horizontal lines indicate the overall cumulative risk of the placebo and vaccine arms by Day \protect\input{`r pathCoRoutput`/timepoints_cum_risk_`r fname.suffix`} and its 95\% point-wise confidence interval. Histograms of the immunological markers in the vaccine arm are overlaid. `r if(!startsWith(a,"Delta")) paste0(llox_labels[assay], "=", lloxs[assay], ".")`]{\includegraphics
  [width=.48\textwidth,keepaspectratio]{`r paste0(pathCoRoutput, "/", a, "_")`marginalized_risks_eq_`r fname.suffix`.pdf}}
...
\center
  ...
  [width=.48\textwidth,keepaspectratio]{`r paste0(pathCoRoutput, "/", a, "_")`controlled_ve_curves_eq_manus_`r fname.suffix`}}
  \hspace{10pt}
  \subfloat[][Controlled VE as functions of Day `r tpeak` markers (=s) among vaccine recipients with 95\% bootstrap point-wise confidence bands (\protect\input{`r pathCoRoutput`/bootstrap_replicates} replicates). Histograms of the immunological markers in the vaccine arm are overlaid. `r if(!startsWith(a,"Delta")) paste0(llox_labels[assay], "=", lloxs[assay], ".")`]{\includegraphics
  [width=.48\textwidth,keepaspectratio]{`r paste0(pathCoRoutput, "/", a, "_")`controlled_ve_curves4_`r fname.suffix`}}
