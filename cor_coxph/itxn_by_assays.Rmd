...
\center
  ...
  [width=.48\textwidth,keepaspectratio]{`r pathCoRoutput`/itxn_marginalized_risks_2_`r a`_`r b`}}
  \hspace{10pt}
  \subfloat[][]{\includegraphics
  [width=.48\textwidth,keepaspectratio]{`r pathCoRoutput`/itxn_marginalized_risks_2_`r b`_`r a`}}
