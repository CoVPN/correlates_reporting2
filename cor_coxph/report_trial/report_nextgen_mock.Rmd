```{r}
# all chunks are unnamed b/c this Rmd is called twice.

# these are partial CORs, to be appended with sera etc conditioning on the marker_set
CORs = c(
  "D31toM5_nextgen_mock", 
  "D31toM12_nextgen_mock",
  "M5toM12_nextgen_mock"
)
CORs = paste0(CORs, "_", endpoint)

labels <- c(
  "M5, Investigational vaccine", 
  "M5, Comparator vaccine", 
  "M12, Investigational vaccine", 
  "M12, Comparator vaccine",
  "VxDistal, Investigational vaccine", 
  "VxDistal, Comparator vaccine"
)
