...
This is the stage 1, monovalent vaccine Sanofi trial.
...
There is an alternative analysis using only batch 0 and 1 data are conducted for nAb markers. Variants ID50 in this analysis are multiply imputed based on ancestral ID50 since they are not measured. 
