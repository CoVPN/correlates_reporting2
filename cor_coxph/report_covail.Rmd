...
\vspace{.5cm}
**Peak Obj 3 Baseline x D15 or D15/B**

Significant interaction between baseline and D15 markers, non-significant interaction between baseline and D15/Baseline markers.
...
\vspace{.5cm}
**Peak Obj 31 Baseline H/M/L x D15 or D15/B**
...
\vspace{.5cm}
**Peak Obj 32 Baseline + D15/B**

Fold changes not significant even after adjusting for baseline markers.
