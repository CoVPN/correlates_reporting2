...
for (COR in c("D15to181", "D15to91", "D92to181", "D15to181BA45", "D15to91BA45", "D92to181BA45")) {
  ...
  cat("# Objective Peak 1 Baseline Marker L/M/H ", COR, "\n", sep="")
...
# Modeling
cat("# Modeling for all COVID\n", sep="")
  
cat("B+D15^2 has the best log likelhood overall. There are trends in cox.zph P values.\n\n")
...
for (COR in c("D15to181", "D15to91", "D92to181")) {
  ...
  cat("\\clearpage")
  cat("## ",COR,  "\n\n", sep="")
  cat("Each number comes from a model. Each row represents one population; N: naive, NN: non-naive. The Bcat*D15cat model is the saturated model. \n\n")
  ...
  cat("Each column represents one formula. B: baseline MDW, D15: Day 15 MDW. Markers are centered and scaled to make the coef more interpretable because quadratic modeles are included. \n\n")
  
  cat("N+NN (dat.onedosemRNA)\n\n")
  cat("\\input{", pathCoRoutput, "/mdw_models_N+NN.tex}\n\n", sep="")
  cat("Naive\n\n")
  cat("\\input{", pathCoRoutput, "/mdw_models_N.tex}\n\n", sep="")
  cat("Non-naive\n\n")
  cat("\\input{", pathCoRoutput, "/mdw_models_NN.tex}\n\n", sep="")
  
  
  cat("\\clearpage\n\n")
  cat("**Models with discrete baseline and Day15 markers**\n\n")
  cat("Instead of fitting the fully saturated model, which has 8 dof for the two L/M/H markers together, we choose to fit a model with 6 dof by merging L/M and L/H and merging M/L and M/H so that we don't have levels with 10 or less subjects among the Naive.\n\n")
