...
Most analyses are repeated six times for D15to181, D15to91, D92to181, D15to181BA45, D15to91BA45, and D92to181BA45, each having its own chapters. In a chapter name ends with BA45, cases other than BA4/BA5 are censored.

Some analyses are also repeated separately within naive and non-naive in new chapters.
 
When more than one marker is present in model, e.g. B + D15^2, the markers are centered (not scaled) so that the coefficients do not explode.  
...
for (iObj in c(1,11,12)) { 
  ...
  for (COR in c("D15to181", "D15to91", "D92to181", "D15to181BA45", "D15to91BA45", "D92to181BA45")) {
    ...
    cat("# Objective Peak ", 
        switch(iObj%.%"", 
               "1"="1, N or NN", 
               "11"="1, N or NN baseline+D15/B", 
               "12"="1, N or NN baseline+D15^2"), 
        ", ", COR, sep="")
...
for (COR in c("D15to181", "D15to91", "D92to181", "D15to181BA45", "D15to91BA45", "D92to181BA45")) {
  ...
  cat("# Objective Peak 1, baseline L/M/H ", COR, "\n", sep="")
