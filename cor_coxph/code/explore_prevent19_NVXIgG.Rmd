...
The smallest value of NVX IgG is 100, consistent with LLOQ being 200. Is the unit EU (ELISA Unit)? Should we divide by 12 to get IU? Are there different LOD, and pos.cutoff? Is there ULOQ?
```{r}
