...
COR="D29IncludeNotMolecConfirmed"
...
mytex(tab.cont, file.name="CoR_univariable_svycoxph_pretty_ENSEMBLE", align="c", include.colnames = F, save2input.only=T, input.foldername=here::here("output"),
...
mytex(tab.cat, file.name="CoR_univariable_svycoxph_cat_pretty_ENSEMBLE", align="c", include.colnames = F, save2input.only=T, input.foldername=here::here("output"),
    col.headers=paste0("\\hline\n 
