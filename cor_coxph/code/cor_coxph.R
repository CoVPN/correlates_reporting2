#Args=c(COR="D57"); Sys.setenv(VERBOSE = 1); Sys.setenv(TRIAL = "moderna_real") # TRIAL: moderna_mock  moderna_real  janssen_pooled_mock  janssen_pooled_real  janssen_na_mock  hvtn705
