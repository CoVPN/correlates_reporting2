...
Correlation plot between baseline and D35 marker suggests that the lower limit for the assay is around 1 on the log10 scale.
```{r}
par(mfrow=c(1,2))
...
The positivity rate is low at D35, around 50%.
```{r}
hist(subset(dat_mapped, EarlyinfectionD35==0 & Perprotocol==1 & Bserostatus==0 & Trt==1 & SubcohortInd==1)$Day35bindSpike)
```
