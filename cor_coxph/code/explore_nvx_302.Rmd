...
dat_mapped=read.csv('/trials/covpn/p3004/analysis/mapping_immune_correlates/UK 302/adata/COVID_Novavax_302UK_mapped_20240207.csv')
...
with(dat_mapped, table(CohortInd, EventIndPrimaryD35, Trt))
```
