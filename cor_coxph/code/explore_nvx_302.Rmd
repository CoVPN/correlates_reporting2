...
10**sort(unique(dat_mapped$BbindNVXIgGIU))[1:10]
10**sort(unique(dat_proc$Day35bindNVXIgG[dat_proc$ph2.D35==1]))[1:10]
10**sort(unique(dat_proc$Day35bindNVXIgGIU[dat_proc$ph2.D35==1]))[1:10]
```
