...
dat=subset(dat_proc, Trialstage==2 & EventIndOmicronD43M5hotdeck10==0 & Trt==0 & ph2.D43.nAb); nrow(dat)

for (a in nassays) {
  dat[[glue("pos_{a}")]] = dat[[glue("B{a}")]] < 1.4 & dat[[glue("Day43{a}")]] > log10(160) |
