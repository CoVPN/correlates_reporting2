...
```{r}
tmp=subset(dat_proc, Trialstage==1 & Bserostatus==1 & Trt==0 & ph2.D43.st1.nAb.batch0and1, c(BbindSpike, Day22bindSpike, Day43bindSpike))

mymatplot(t(tmp), legend=F, col=1:8, lty=1)
```
