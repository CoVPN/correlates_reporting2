...
dat_proc = read.csv('/trials/covpn/p3005/analysis/correlates/Part_A_Blinded_Phase_Data/adata/vat08_combined_data_processed_20250320.csv')
...
dat=subset(dat_proc, Trialstage==2 & Bserostatus==1)
mytable(round(dat$Wstratum))
