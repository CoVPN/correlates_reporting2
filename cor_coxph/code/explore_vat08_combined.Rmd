...
Overall, "because the correlation among variants is pretty good for the non-naives and really the analysis focuses on the non-naives" (Peter), we decide to impute variants for those who have data for at least one variant to make the complexity of data processing more manageable. The missingenss pattern across variants is shown in the next section.
