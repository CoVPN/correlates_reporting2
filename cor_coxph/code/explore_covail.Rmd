...
# covail_data_processed_20250726.csv is also the same but without frnt columns
dat2=read.csv("~/correlates_processing/data_clean/csv/covail_data_processed_20250726.csv")
dat3=dat2[,colnames(dat2)%in%colnames(dat1)]
