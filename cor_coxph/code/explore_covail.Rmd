...
# later file is also the same but frnt markers have changed (3 new imputations)
dat2=read.csv("~/correlates_processing/data_clean/csv/covail_data_processed_20250818.csv")
dat3=dat2[,colnames(dat2)%in%colnames(dat1)]
