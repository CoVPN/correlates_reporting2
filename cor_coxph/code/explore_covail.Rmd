...
dat_proc=read.csv('/trials/covpn/COVAILcorrelates/analysis/correlates/adata/covail_data_processed_20250430.csv')
...
S1=tmp[!endsWith(tmp, ".N")]%.%".S1"; S1
S2=tmp[!endsWith(tmp, ".N")]%.%".S2"; S2
