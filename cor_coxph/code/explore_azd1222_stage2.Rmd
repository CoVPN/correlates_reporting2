...
dat_mapped=read.csv('/trials/covpn/p3002/analysis/mapping_immune_correlates/stage2/adata/COVID_AstraZeneca_stage2_mapped_20240312.csv')
...
```{r}
with(subset(dat_mapped, EarlyinfectionD57==0 & Perprotocol==1 & Bserostatus==0 & Trt==1), mytable(!is.na(Day57bindSpike_Delta3), DeltaEventIndD57_124to303))
```
...
myboxplot(EventTimePrimaryD57~EventIndPrimaryType_short, dat_mapped, ylab="EventTimePrimary57",
          col=ifelse(dat_mapped$SevereEventIndD57_7to303==1,2,ifelse(!is.na(dat_mapped$Day57bindSpike_Delta3),3,1)), cex.axis=0.8)
abline(h=120, lty=2) 


# myboxplot(as.Date(DateDD1)~EventIndPrimaryType_short, subset(dat_mapped), ylab="DateDD1",
          # col=ifelse(!is.na(dat_mapped$Day57bindSpike_Delta3),3,1))
