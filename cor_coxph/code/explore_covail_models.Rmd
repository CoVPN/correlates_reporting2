...
corplot(Bcd4_IFNg.IL2_BA.4.5.S~Day15pseudoneutid50_BA.1, subset(dat.onedosemRNA, naive==0), col=subset(dat.onedosemRNA, naive==0, COVIDIndD22toD181, drop=T)+1, cex=1.2)
