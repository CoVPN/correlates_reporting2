...
dat_mapped=read.csv('/trials/covpn/p3004/analysis/mapping_immune_correlates/stage2/adata/COVID_Novavax_stage2_mapped_20240304.csv')
...
```{r}
with(subset(dat_mapped, ph1.D35==1), mytable(Severity))
```
