...
dat_proc=read.csv('/trials/covpn/p3004/analysis/correlates/stage2/adata/prevent19_stage2_data_processed_20240327.csv')
#dat_proc=read.csv('/trials/covpn/p3004/analysis/correlates/stage2/adata/prevent19_stage2_data_processed_20240402.csv')
...
dat = subset(dat_proc, ph1.D35==1 & Country==0 & Trt==1)

# temp hack, EventIndD35_7to21Dec10 will be defined by yiwen later
...
mytable(dat$EventIndD35_7to21Dec10, dat$AllButDeltaEventIndD35_108to21Dec10)
mytable(dat$EventIndD35_7to21Dec10, dat$DeltaEventIndD35_108to21Dec10)
...
Variants
```{r}
with(subset(dat_proc, ph1.D35==1 & Country==0), mytable(VARTYPE_first, VARTYPE_first1))
with(subset(dat_proc, ph1.D35==1 & Country==0), mytable(VARTYPE_first1, ph2.D35))
```
...
```{r}
with(subset(dat_proc, ph1.D35==1 & Country==0 & VARTYPE_first=="Delta"), mytable(Severity_first, ph2.D35, EventIndFirstD1))
subset(dat_proc, ph1.D35==1 & Country==0 & Severity_first=="LESS THAN MILD" & ph2.D35, Ptid)
```
...
```{r}
dat.tmp2=subset(dat_proc, ph1.D35==1 & Country==0 & Trt==1 & SubcohortInd==1)
...
```{r}
with(subset(dat_proc, Trt==1 & ph2.D35_108), sort(EventTimeD35_to21Dec10[DeltaEventIndD35_108to21Dec10==1], decreasing = T)[1:10])
with(subset(dat_proc, Trt==1 & ph2.D35_108), sort(SevereEventTimeD35_to21Dec10[SevereEventIndD35_108to21Dec10==1], decreasing = T)[1:10])
subset(dat_proc, Trt==1 & ph2.D35_108 & EventTimeD35_to21Dec10==305)
```

vaccine group risk
```{r}
with(subset(dat_proc, Trt==1 & ph1.D35_108), mean(DeltaEventIndD35_108to21Dec10))
```
...
```{r}
dat.tmp=subset(dat, EventIndD35_7to21Dec10==1 & VARTYPE_first1 %in% c("Delta","Unk"))
...
```{r, echo=T}
with(subset(dat_proc, ph1.D35==1 & Country==0 & Bserostatus==0 & Trt==1), mytable(ph2.D35, DeltaEventIndD35_108to21Dec10))

with(subset(dat_proc, ph1.D35==1 & Country==0 & Bserostatus==0 & Trt==1), mytable(ph2.D35, SevereEventIndD35_108to21Dec10))

with(subset(dat_proc, ph1.D35==1 & Country==0 & Bserostatus==0 & Trt==1 & Severity_first=="SEVERE"), mytable(VARTYPE_first1, ph2.D35))
...
```{r}
with (subset(dat_proc, ph1.D35==1 & Trt==1 & Bserostatus==0 & Country==0), mytable(ph2.D35, Wstratum))
```
...
```{r}
coxph(Surv(SevereEventTimeD35_to21Dec10, SevereEventIndD35_108to21Dec10)~Age, subset(dat_proc, ph1.D35_108==1 & Country==0 & Trt==1))
coxph(Surv(SevereEventTimeD35_to21Dec10, SevereEventIndD35_108to21Dec10)~Senior, subset(dat_proc, ph1.D35_108==1 & Country==0 & Trt==1))
```


We will **adjust for age group in Delta COVID correlates analyses**. Risk of Delta COVID decreases with age group.
```{r}
coxph(Surv(EventTimeD35_to21Dec10, DeltaEventIndD35_108to21Dec10)~Age, subset(dat_proc, ph1.D35_108==1 & Country==0 & Trt==1))
coxph(Surv(EventTimeD35_to21Dec10, DeltaEventIndD35_108to21Dec10)~Senior, subset(dat_proc, ph1.D35_108==1 & Country==0 & Trt==1))
```
...
mytable(dat_proc$SubcohortInd, dat_proc$ph2.D35_108, dat_proc$SevereCOVIDIndD35_108to21Dec10)
```
