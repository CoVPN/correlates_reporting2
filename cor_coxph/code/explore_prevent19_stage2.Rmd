...
```{r}
with (subset(dat_proc, ph1.D35==1 & Trt==1 & Bserostatus==0 & Country==0), table(ph2.D35, Wstratum))
```

Distribution of weights
```{r}
with (subset(dat_proc, ph1.D35_108==1 & Trt==1 & Bserostatus==0 & Country==0), table(wt.D35_108, Wstratum))
```
