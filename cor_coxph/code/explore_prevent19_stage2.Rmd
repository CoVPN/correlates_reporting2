...
```{r}
dat.tmp = subset(dat_proc, ph1.D35==1 & Country==0 & Trt==1)
...
abline(h=108, lty=2)
sort(subset(dat.tmp, VARTYPE_first1=="Delta", EventTimeFirstD35, drop=T))[1:5]
subset(dat.tmp, VARTYPE_first1=="Delta" & EventTimeFirstD35<=108, EventCalTimeFirstD35) 
...
subset(dat.tmp, Severity_first=="SEVERE" & is.na(VARTYPE_first1) & ph2.D35, c(Ptid, VARTYPE_first, EventIndFirstD1, Severity_first))
```
