...
ff=try.error(load(file=paste("~/TND/Ensemble/Result/outd3_LRT2_event",ind.event,"_marker",ind.marker,"_region",ind.region,"_iter",iter,".Rdata",sep='')))
...
load(file=paste("~/TND/Ensemble/Result/outd3_LRT2_event",ind.event,"_marker",ind.marker,"_region",ind.region,".Rdata",sep=''))
...
#  fit23.b<-optim(c(B00,B2E,B3E,B4E),nloglik.M1.b.Cal.23)
 ...
 fit2.b,
file=paste("~/TND/Ensemble/Result/outd3_LRT2_event",ind.event,"_marker",ind.marker,"_region",ind.region,"_iter",iter,".Rdata",sep=''))
