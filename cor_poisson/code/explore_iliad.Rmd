...
```{r Delta28overBFHA_Norm_Nasal_IgA, echo=F}

fit.gee <- geeglm(EventIndC9_11_14 ~ Delta28overBFHA_Norm_Nasal_IgA, data  = subset(dat_proc_202, Trt == "PBO"), family= poisson(link = "log"),
...
getFormattedSummary(list(fit.gee), robust=F, type=12)
...
myboxplot(Delta28overBFHA_Norm_Nasal_IgA~EventIndC9_11_14, subset(dat_proc_202, Trt == "PBO"), test="w")

t.test(Delta28overBFHA_Norm_Nasal_IgA~EventIndC9_11_14, subset(dat_proc_202, Trt == "PBO"))

```

```{r}
fit.gee <- geeglm(EventIndC9_11_14 ~ Day28FHA_Norm_Nasal_IgA, data  = subset(dat_proc_202, Trt == "BPZE1"), family= poisson(link = "log"),
  id = Ptid, corstr= "independence")
...
myboxplot(Day28FHA_Norm_Nasal_IgA~EventIndC9_11_14, subset(dat_proc_202, Trt == "BPZE1"), test="w")

t.test(Day28FHA_Norm_Nasal_IgA~EventIndC9_11_14, subset(dat_proc_202, Trt == "BPZE1"))

```

```{r}
fit.gee <- geeglm(EventIndC9_11_14 ~ Delta28overBFIM_Norm_Nasal_IgA, data  = subset(dat_proc_202, Trt == "PBO"), family= poisson(link = "log"),
  id = Ptid, corstr= "independence")
...
myboxplot(Delta28overBFIM_Norm_Nasal_IgA~EventIndC9_11_14, subset(dat_proc_202, Trt == "PBO"), test="w")

t.test(Delta28overBFIM_Norm_Nasal_IgA~EventIndC9_11_14, subset(dat_proc_202, Trt == "PBO"))
