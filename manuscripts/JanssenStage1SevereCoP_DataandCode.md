# Summary of sharing of data and code for Carpp et al. “Neutralizing Antibody Correlate of Vaccine Protection Against Severe-Critical COVID-19”

**Youyi Fong, Peter Gilbert**

**November 27, 2025**

- All analyses are based on the analysis-ready data file janssen_pooled_partA_data_processed_with_riskscore_20240226.csv unless otherwise specified.


**Code set up**
1.	Download and unzip the release
https://github.com/CoVPN/correlates_reporting2/archive/refs/tags/2.2.2.zip
2.	Modify renv.lock to add the following at the line below Packages:
    "ggnewscale": {
      "Package": "ggnewscale",
      "Version": "0.5.0",
      "Source": "Repository",
      "Repository": "CRAN",
      "Hash": "0e4714a05e572eacd7c232fde675558e"
},
3.	Start R at the repo root level. Run the following to install the packages via renv.
...
4.	Modify config.yml line 169 to point the local copy of analysis-ready data file.
