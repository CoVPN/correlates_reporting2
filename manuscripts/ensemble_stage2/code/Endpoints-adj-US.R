...
write.csv(Tab, paste0(spath, "/reports/AdjEndpoints-US_", Sys.Date(), ".csv"))
# write.csv(Tab, "/Volumes/ahudson/Ensemble-stage2-correlates/SummaryTables/AdjEndpoints-US.csv")
...
# write.csv(Tab, "/Volumes/ahudson/Ensemble-stage2-correlates/SummaryTables/AdjEndpoints90Days-US.csv")
write.csv(Tab, paste0(spath, "/reports/AdjEndpoints90Days-US_", Sys.Date(), ".csv"))
...
# pdf("/Volumes/ahudson/Ensemble-stage2-correlates/Summary Figures/AdjSurvivalCurves-US.pdf")
pdf(paste0(spath, "/reports/AdjSurvivalCurves-US_", Sys.Date(), ".pdf"))
...
# pdf("/Volumes/ahudson/Ensemble-stage2-correlates/Summary Figures/AdjSurvivalCurves90Days-US.pdf")
pdf(paste0(spath, "/reports/AdjSurvivalCurves90Days-US_", Sys.Date(), ".pdf"))
fit <- survfit(Surv(event = AdjModtoSevEventIndPrimaryBD14_CensorAtOutsideVacc, time = AdjModtoSevEventTimePrimaryBD14_CensorAtOutsideVacc) ~ group,
               data = ensemble.dat)
ggsurvplot(fit, data = ensemble.dat, risk.table = TRUE, censor = FALSE, title = "Primary COVID", fun = "event",
...
# pdf("/Volumes/ahudson/Ensemble-stage2-correlates/Summary Figures/DateDose2-US.pdf")
pdf(paste0(spath, "/reports/DateDose2-US_", Sys.Date(), ".pdf"))
...
sum(ensemble.dat$AdjAnyEventIndPrimaryBD14_CensorAtOutsideVacc == 1 &
    ensemble.dat$AdjModtoSevEventIncludePrimaryBD35_CensorAtOutsideVacc == 0 &
    ensemble.dat$AdjAsymEventIndPrimaryBD14_CensorAtOutsideVacc == 0)
