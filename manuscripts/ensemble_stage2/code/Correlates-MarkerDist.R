...
# pdf(file = "/Volumes/ahudson/Ensemble-stage2-correlates/EfficacyImmunoCorrelates/Immuno-Vioplots-Case.pdf", width = 9, height = 7)  
pdf(file = paste0(spath, "/reports/Immuno-Vioplots-Case_",  Sys.Date(), ".pdf"))

#BA.4.5 (Severe-critical; Hybrid)
case <- ensemble.dat.immuno$AdjSevEventIndPrimaryBD35_CensorAtOutsideVacc == 1 &
  ensemble.dat.immuno$AdjSevEventTimePrimaryBD35_CensorAtOutsideVacc <= t0
non.case <- ensemble.dat.immuno$AdjSevEventIndPrimaryBD35_CensorAtOutsideVacc == 0 &
  ensemble.dat.immuno$AdjSevEventTimePrimaryBD35_CensorAtOutsideVacc > t0
vioplot(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[case & A == 1],
        ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[non.case & A == 1],
        drawRect = FALSE,
...
points(x = rnorm(sum(case & A == 1), mean = 1, sd = .1),
       y = ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[case & A == 1],
       cex = .4, col = "black")
points(x = rnorm(sum(non.case & A == 1), mean = 2, sd = .1),
       y = ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[non.case& A == 1],
       cex = .4, col = "black")
...
text(x = 1, y = 5, paste0("N = ", sum(case & A == 1),
                          "\nPR = ", round(100 * mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[case & A == 1] >
                                             ppr.cutoff, na.rm = TRUE),
                                digits = 1), "%",
                          "\nGM = ", round(10^mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[case & A == 1], na.rm = TRUE), 1)))
text(x = 2, y = 5, paste0("N = ", sum(non.case & A == 1),
                          "\nPR = ", round(100 * mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[non.case & A == 1] >
                                                      ppr.cutoff, na.rm = TRUE),
                                         digits = 1), "%",
                          "\nGM = ", round(10^mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[non.case & A == 1], na.rm = TRUE), 1)))

#BA.4.5 (Mod-to-Severe-critical)
case <- ensemble.dat.immuno$AdjModtoSevEventIndPrimaryBD35_CensorAtOutsideVacc == 1 &
  ensemble.dat.immuno$AdjModtoSevEventTimePrimaryBD35_CensorAtOutsideVacc <= t0
non.case <- ensemble.dat.immuno$AdjModtoSevEventIndPrimaryBD35_CensorAtOutsideVacc == 0 &
  ensemble.dat.immuno$AdjModtoSevEventTimePrimaryBD35_CensorAtOutsideVacc > t0
vioplot(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[case & A == 1],
        ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[non.case & A == 1],
        drawRect = FALSE,
...
#BA.4.5 (Any)
case <- ensemble.dat.immuno$AdjAnyEventIndPrimaryBD35_CensorAtOutsideVacc == 1 &
  ensemble.dat.immuno$AdjAnyEventTimePrimaryBD35_CensorAtOutsideVacc <= t0
non.case <- ensemble.dat.immuno$AdjAnyEventIndPrimaryBD35_CensorAtOutsideVacc == 0 &
  ensemble.dat.immuno$AdjAnyEventTimePrimaryBD35_CensorAtOutsideVacc > t0
vioplot(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[case & A == 1],
        ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[non.case & A == 1],
        drawRect = FALSE,
...
non.case <- ensemble.dat.immuno$AdjSevEventIndPrimaryBD35_CensorAtOutsideVacc == 0 &
  ensemble.dat.immuno$AdjSevEventTimePrimaryBD35_CensorAtOutsideVacc > t0
vioplot(ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[case & A == 1],
        ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[non.case & A == 1],
        drawRect = FALSE,
        xlab = "", ylab = "nAb-ID50 Titer (AU/mL)",
...
points(x = rnorm(sum(case & A == 1), mean = 1, sd = .1),
       y = ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[case & A == 1],
       cex = .4, col = "black")
points(x = rnorm(sum(non.case & A == 1), mean = 2, sd = .1),
       y = ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[non.case& A == 1],
       cex = .4, col = "black")
...
text(x = 1, y = 5, paste0("N = ", sum(case & A == 1),
                          "\nPR = ", round(100 * mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[case & A == 1] >
                                                      ppr.cutoff, na.rm = TRUE),
                                         digits = 1), "%",
                          "\nGM = ", round(10^mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[case & A == 1], na.rm = TRUE), 1)))
text(x = 2, y = 5, paste0("N = ", sum(non.case & A == 1),
                          "\nPR = ", round(100 * mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[non.case & A == 1] >
                                                      ppr.cutoff, na.rm = TRUE),
                                         digits = 1), "%",
                          "\nGM = ", round(10^mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[non.case & A == 1], na.rm = TRUE), 1)))
...
non.case <- ensemble.dat.immuno$AdjSevEventIndPrimaryBD35_CensorAtOutsideVacc == 0 &
  ensemble.dat.immuno$AdjSevEventTimePrimaryBD35_CensorAtOutsideVacc > t0
vioplot(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[case & A == 0],
        ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[non.case & A == 0],
        drawRect = FALSE,
        xlab = "", ylab = "nAb-ID50 Titer (AU/mL)",
...
points(x = rnorm(sum(case & A == 0), mean = 1, sd = .1),
       y = ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[case & A == 0],
       cex = .4, col = "black")
points(x = rnorm(sum(non.case & A == 0), mean = 2, sd = .1),
       y = ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[non.case& A == 0],
       cex = .4, col = "black")
...
text(x = 1, y = 5, paste0("N = ", sum(case & A == 0),
                          "\nPR = ", round(100 * mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[case & A == 0] >
                                                      ppr.cutoff, na.rm = TRUE),
                                         digits = 1), "%",
                          "\nGM = ", round(10^mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[case & A == 0], na.rm = TRUE), 1)))
text(x = 2, y = 5, paste0("N = ", sum(non.case & A == 0),
                          "\nPR = ", round(100 * mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[non.case & A == 0] >
                                                      ppr.cutoff, na.rm = TRUE),
                                         digits = 1), "%",
                          "\nGM = ", round(10^mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_BA.4.5[non.case & A == 0], na.rm = TRUE), 1)))
...
non.case <- ensemble.dat.immuno$AdjSevEventIndPrimaryBD35_CensorAtOutsideVacc == 0 &
  ensemble.dat.immuno$AdjSevEventTimePrimaryBD35_CensorAtOutsideVacc > t0
vioplot(ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[case & A == 0],
        ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[non.case & A == 0],
        drawRect = FALSE,
        xlab = "", ylab = "nAb-ID50 Titer (AU/mL)",
...
points(x = rnorm(sum(case & A == 0), mean = 1, sd = .1),
       y = ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[case & A == 0],
       cex = .4, col = "black")
points(x = rnorm(sum(non.case & A == 0), mean = 2, sd = .1),
       y = ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[non.case& A == 0],
       cex = .4, col = "black")
...
text(x = 1, y = 5, paste0("N = ", sum(case & A == 0),
                          "\nPR = ", round(100 * mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[case & A == 0] >
                                                      ppr.cutoff, na.rm = TRUE),
                                         digits = 1), "%",
                          "\nGM = ", round(10^mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[case & A == 0], na.rm = TRUE), 1)))
text(x = 2, y = 5, paste0("N = ", sum(non.case & A == 0),
                          "\nPR = ", round(100 * mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[non.case & A == 0] >
                                                      ppr.cutoff, na.rm = TRUE),
                                         digits = 1), "%",
                          "\nGM = ", round(10^mean(ensemble.dat.immuno$Year1_28dayspseudoneutid50_B.1[non.case & A == 0], na.rm = TRUE), 1)))
...
X.case <- X * ensemble.dat.immuno$wt.immuno/mean(ensemble.dat.immuno$wt.immuno[A == 1 & case])
X.non.case <- X * ensemble.dat.immuno$wt.immuno/mean(ensemble.dat.immuno$wt.immuno[A == 1 & non.case])
...
X.case <- X * ensemble.dat.immuno$wt.immuno/mean(ensemble.dat.immuno$wt.immuno[A == 0 & case])
X.non.case <- X * ensemble.dat.immuno$wt.immuno/mean(ensemble.dat.immuno$wt.immuno[A == 0 & non.case])
...
# write.csv(tab, "/Volumes/ahudson/Ensemble-stage2-correlates/EfficacyImmunoCorrelates/correlates-weighted-GM.csv")
write.csv(tab, paste0(spath, "/reports/correlates-weighted-GM_", Sys.Date(), ".csv"))
