...
write.csv(Tab, paste0(spath, "/reports/AdjEndpoints-LatinAmerica_", Sys.Date(), ".csv"))
# write.csv(Tab, "/Volumes/ahudson/Ensemble-stage2-correlates/SummaryTables/AdjEndpoints-LatinAmerica.csv")
...
# write.csv(Tab, "/Volumes/ahudson/Ensemble-stage2-correlates/SummaryTables/AdjEndpoints90Days-LatinAmerica.csv")
write.csv(Tab, paste0(spath, "/reports/AdjEndpoints90Days-LatinAmerica_", Sys.Date(), ".csv"))
...
# pdf("/Volumes/ahudson/Ensemble-stage2-correlates/Summary Figures/AdjSurvivalCurves-LatinAmerica.pdf")
pdf(paste0(spath, "/reports/AdjSurvivalCurves-LatinAmerica_", Sys.Date(), ".pdf"))
...
# pdf("/Volumes/ahudson/Ensemble-stage2-correlates/Summary Figures/AdjSurvivalCurves90Days-LatinAmerica.pdf")
pdf(paste0(spath, "/reports/AdjSurvivalCurves90Days-LatinAmerica_", Sys.Date(), ".pdf"))
fit <- survfit(Surv(event = AdjModtoSevEventIndPrimaryBD14_CensorAtOutsideVacc, time = AdjModtoSevEventTimePrimaryBD14_CensorAtOutsideVacc) ~ group,
               data = ensemble.dat)
ggsurvplot(fit, data = ensemble.dat, risk.table = TRUE, censor = FALSE, title = "Primary COVID", fun = "event",
...
fit <- survfit(Surv(event = AdjSevEventIndPrimaryBD14_CensorAtOutsideVacc, time = AdjSevEventTimePrimaryBD14_CensorAtOutsideVacc) ~ group,
               data = ensemble.dat)
ggsurvplot(fit, data = ensemble.dat, risk.table = TRUE, censor = FALSE, title = "Severe-critical-critical COVID", fun = "event",
           conf.int = TRUE, xlim = c(0, 90))
...
# pdf("/Volumes/ahudson/Ensemble-stage2-correlates/Summary Figures/DateDose2-LatinAmerica.pdf")
pdf(paste0(spath, "/reports/DateDose2-LatinAmerica_", Sys.Date(), ".pdf"))
