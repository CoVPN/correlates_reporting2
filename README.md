...
* Pdf reports are generated by shell scripts. For example, to run the PREVENT-19 cor_coxph report, run 
```bash
bash run_prevent19 cor_coxph
```
which will create a pdf file under the cor_coxph directory.
