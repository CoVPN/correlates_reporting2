...
if (study_name == "NextGen_Mock") {
    ...
    nextgen_output_flag = "sera_only_ics" # "whole_report"  # "BARDA_TLF"
}
```
    ...
    for (trt in c("trt_both", paste0("trt_", trt.labels.2[2]), if (study_name %in% c("VAT08")) paste0("trt_", trt.labels.2[1]))){
        ...
        for (bsero in c("bstatus_both", "bstatus_Neg", "bstatus_Pos")){
            ...
            for (asy in if(study_name=="VAT08" | attr(config,"config")=="janssen_partA_VL") {c("bAb","nAb")
              ...
              c("bAb_IgG_sera", "bAb_IgA_sera", "nAb_sera", 
                if (nextgen_output_flag == "whole report") c("bAb_IgG_nasal", "bAb_IgA_nasal", "nAb_nasal", "bAb_IgG_saliva", "bAb_IgA_saliva", "nAb_saliva"),
                "ics")
...
if(study_name %in% c("VAT08", "NextGen_Mock") | attr(config,"config")=="janssen_partA_VL"){
    ...
    c("bind.*sera", if (nextgen_output_flag == "whole report") c("bind.*nasal", "bind.*saliva"), 
      "pseudo.*sera", if (nextgen_output_flag == "whole report") c("pseudo.*nasal", "pseudo.*saliva"), 
      "ics")
    } else {c("bind", "pseudo")}){
...
for (bsero in c(bstatus.labels.2, if(study_name=="VAT08") c("bstatus"#, "bstatus_gender"
    ...
    for(tp in times_[!times_ %in% c(paste0("Delta",timepoints_[length(timepoints_)],"over",timepoints_[1]))]) {
        ...
        for (pn in if (study_name != "NextGen_Mock") {""} else {c(c("IgG_sera", "IgA_sera", "pseudoneutid50_sera",
...
for (tp in if (study_name == "NextGen_Mock") {tps_no_fold_change} else {tps_no_delta_over_tinterm}){
    for (a in if (study_name == "NextGen_Mock") {c("IgG_sera", "pseudoneutid50_sera", if (nextgen_output_flag == "whole report") c("IgG_nasal", "pseudoneutid50_nasal", "IgG_saliva", "pseudoneutid50_saliva"), "T4", "T8")
...
for (assay_grp in if (study_name == "NextGen_Mock") {
    gsub("\\|", "__", gsub("\\$", "", c("bindSpike_IgG_sera$|bindSpike_IgG_sera_delta_AY.4$",
     ...
     if (nextgen_output_flag == "whole_report") c("bindSpike_IgG_nasal$|bindSpike_IgG_nasal_delta_AY.4$",
        ...
        for (tp in tps_no_fold_change){
            ...
            for (asy in if (study_name != "NextGen_Mock") {""} else {
                c("IgG_sera", "bindSpike_IgA_sera", "pseudoneutid50_sera", 
                  ...
                  if (nextgen_output_flag == "whole_report") c(
                  ...
                  if (nextgen_output_flag == "whole_report") c("IgG_nasal_KP.2|bindSpike_IgA_nasal_KP.2", "IgG_nasal_KP.2|pseudoneutid50_nasal", "IgG_nasal_KP.2|T4", "IgG_nasal_KP.2|T8",
