 ...
 for(tp in if (study_name == "NextGen_Mock") {c(paste0(tps_no_fold_change, "_initial"), paste0(tps_no_fold_change[c(1,2,4)], "_final"))} else {times_[!times_ %in% c("B",paste0("Delta",timepoints_[length(timepoints_)],"over",timepoints_[1]))]}) {
    ...
    for (trt in c("trt_both", paste0("trt_", trt.labels.2[2]), if (study_name %in% c("VAT08")) paste0("trt_", trt.labels.2[1]))){
        ...
        for (bsero in c("bstatus_both", "bstatus_Neg", "bstatus_Pos")){
            ...
            } else if (study_name == "NextGen_Mock") {c("bAb_IgG_sera", "bAb_IgA_nasal", "nAb_sera", 
                                   # "bAb_IgG_nasal", "nAb_nasal", "bAb_IgG_saliva", "bAb_IgA_saliva" "nAb_saliva",
                                                        "ics")
...
## Spider plots of antibody markers for RIS or RIS-PBMC cohort
```{r, echo=FALSE, results='asis'}
...
if(study_name %in% c("VAT08", "NextGen_Mock") | attr(config,"config")=="janssen_partA_VL"){
    ...
    c("bind.*IgG_sera", "bind.*nasal", #"bind.*saliva", 
...
for (bsero in c(bstatus.labels.2, if(study_name=="VAT08") c("bstatus"#, "bstatus_gender"
    ...
    for(tp in times_[!times_ %in% c(paste0("Delta",timepoints_[length(timepoints_)],"over",timepoints_[1]))]) {
        ...
        for (pn in if (study_name != "NextGen_Mock") {""} else {c(c("IgG_sera", "IgA_nasal", "pseudoneutid50_sera",
                                                                  #"IgG_nasal", "pseudoneutid50_nasal", 
                                                              #"IgG_saliva", "IgA_saliva", "pseudoneutid50_saliva",
                                                                  "T4_T8"))}) {
        ...
        for (tp in tps_no_fold_change){
            ...
            for (asy in if (study_name != "NextGen_Mock") {""} else {
                ...
                asy_lb = case_when(asy == "IgG_sera" ~ "bAb-IgG Spike and bAb-IgG Nucleocapsid concentrations",
                                   ...
                                   asy == "IgG_sera_KP.2|bindSpike_IgA_nasal_KP.2" ~ "bAb-IgG Spike KP.2 and bAb-IgA Spike KP.2 concentrations",
                                   ...
                                   asy == "bindSpike_IgA_nasal_KP.2|pseudoneutid50_sera" ~ "bAb-IgA Spike KP.2 concentrations and nAb-ID50 titers",
