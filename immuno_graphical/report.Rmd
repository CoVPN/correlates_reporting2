    ...
    for (trt in c("vac_pla", if (study_name == "NextGen_Mock") "vac", if (study_name == "NextGen_Mock") "pla")){
        ...
        for (tp in tps_no_fold_change){
            ...
            for (asy in if (study_name != "NextGen_Mock") {""} else {
                ...
                asy_lb = case_when(grepl("IgG_(sera|nasal|saliva)", asy) ~ "bAb-IgG Spike and bAb-IgG Nucleocapsid concentrations",
                                   grepl("bindSpike_IgA_(sera|nasal|saliva)", asy) ~ "bAb-IgA Spike concentrations",
                                   grepl("pseudoneutid50_(sera|nasal|saliva)", asy) ~ "nAb-ID50 titers",
                                   asy == "T4" ~ "CD4+ T-cell markers to Spike and Nucleocapsid peptides",
                                   asy == "T8" ~ "CD8+ T-cell markers to Spike and Nucleocapsid peptides",
                                   grepl("IgG_(sera|nasal|saliva)_KP.2\\|bindSpike_IgA_(sera|nasal|saliva)_KP.2", asy) ~ "bAb-IgG Spike KP.2 and bAb-IgA Spike KP.2 concentrations",
                                   grepl("IgG_(sera|nasal|saliva)_KP.2\\|pseudoneutid50_(sera|nasal|saliva)", asy) ~ "bAb-IgG Spike KP.2 concentrations and nAb-ID50 titers",
                                   grepl("IgG_(sera|nasal|saliva)_KP.2\\|T4", asy) ~ "bAb-IgG Spike KP.2 concentrations and CD4+ T-cell markers to Spike and Nucleocapsid peptides",
                                   grepl("IgG_(sera|nasal|saliva)_KP.2\\|T8", asy) ~ "bAb-IgG Spike KP.2 concentrations and CD8+ T-cell markers to Spike and Nucleocapsid peptides",
                                   grepl("bindSpike_IgA_(sera|nasal|saliva)_KP.2\\|pseudoneutid50_(sera|nasal|saliva)", asy) ~ "bAb-IgA Spike KP.2 concentrations and nAb-ID50 titers",
                                   grepl("bindSpike_IgA_(sera|nasal|saliva)_KP.2\\|T4", asy) ~ "bAb-IgA Spike KP.2 concentrations and CD4+ T-cell markers to Spike and Nucleocapsid peptides",
                                   grepl("bindSpike_IgA_(sera|nasal|saliva)_KP.2\\|T8", asy) ~ "bAb-IgA Spike KP.2 concentrations and CD8+ T-cell markers to Spike and Nucleocapsid peptides",
                                   grepl("pseudoneutid50_(sera|nasal|saliva)\\|T4", asy) ~ "nAb-ID50 titers and CD4+ T-cell markers to Spike and Nucleocapsid peptides",
                                   grepl("pseudoneutid50_(sera|nasal|saliva)\\|T8", asy) ~ "nAb-ID50 titers and CD8+ T-cell markers to Spike and Nucleocapsid peptides",
