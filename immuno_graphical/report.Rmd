 ...
 for(tp in if (study_name == "NextGen_Mock") {c(paste0(tps_no_fold_change, "_initial"), paste0(tps_no_fold_change[c(1,2,4)], "_final"))} else {times_[!times_ %in% c("B",paste0("Delta",timepoints_[length(timepoints_)],"over",timepoints_[1]))]}) {
    ...
    for (trt in c("trt_both", paste0("trt_", trt.labels.2[2]), if (study_name %in% c("VAT08")) paste0("trt_", trt.labels.2[1]))){
        ...
        for (bsero in c("bstatus_both", "bstatus_Neg", "bstatus_Pos")){
            ...
            } else if (study_name == "NextGen_Mock") {c("bAb_IgG_sera", "bAb_IgA_sera", "nAb_sera", "ics")
        ...
        for (tp in tps_no_fold_change){
            ...
            for (asy in if (study_name != "NextGen_Mock") {""} else {
                ...
                asy_lb = case_when(asy == "IgG_sera" ~ "bAb-IgG Spike and bAb-IgG Nucleocapsid concentrations",
                                   ...
                                   asy == "IgG_sera|bindSpike_IgA_sera" ~ "bAb-IgG Spike, bAb-IgG Nucleocapsid and bAb-IgA Spike concentrations",
                                   asy == "IgG_sera|pseudoneutid50_sera" ~ "bAb-IgG Spike, bAb-IgG Nucleocapsid concentrations and nAb-ID50 titers",
                                   asy == "IgG_sera|T4" ~ "bAb-IgG Spike, bAb-IgG Nucleocapsid concentrations and CD4+ T-cell markers to Spike and Nucleocapsid peptides",
                                   asy == "IgG_sera|T8" ~ "bAb-IgG Spike, bAb-IgG Nucleocapsid concentrations and CD8+ T-cell markers to Spike and Nucleocapsid peptides",
                                   asy == "bindSpike_IgA_sera|pseudoneutid50_sera" ~ "bAb-IgA Spike concentrations and nAb-ID50 titers",
                                   asy == "bindSpike_IgA_sera|T4" ~ "bAb-IgA Spike concentrations and CD4+ T-cell markers to Spike and Nucleocapsid peptides",
                                   asy == "bindSpike_IgA_sera|T8" ~ "bAb-IgA Spike concentrations and CD8+ T-cell markers to Spike and Nucleocapsid peptides",
