        ...
        for (trt in c("placebo", "vaccine")) {
          ...
          for (reg in if(attr(config,"config")=="janssen_partA_VL") {c("LATAM_","ZA_")} else {""}){
            ...
            tpLabel <- case_when(tp == "Day" ~ paste0("Day 1, ", paste0("Day ", timepoints_,  collapse = ", ")), 
                                 tp == "Delta" ~"fold-rise", 
                                 tp == "Day initial" ~ "Day 91 and D366",
                                 tp == "Day whole" ~ "Day 1, Day 31 and Day 181",
...
for (a in if (study_name == "NextGen_Mock") {c("bindN", "bindSpike_IgG_sera", "bindSpike_IgA_sera", "pseudoneutid50_sera", "tcell")
...
for (assay_grp in if (study_name == "NextGen_Mock") {
  c(paste(assays[c(TRUE, FALSE)], 
          assays[c(FALSE, TRUE)], sep = "_"))
