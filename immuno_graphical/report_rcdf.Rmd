...
\caption{`r paste0("RCDF plots for ", tpLabel, " ", ifelse(asy=="", "Ab", asy), " markers: ", bseroLabel," ", ifelse(grepl("by", bseroLabel) & trt!="trt_both", paste0("for the ", trtLabel), trtLabel), ifelse(regLabel!="", paste0(", ", regLabel), ""))`}
