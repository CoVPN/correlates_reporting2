...
\includegraphics[width=1\textwidth]{`r here("immuno_graphical", "output", attr(config,"config"), paste0("pairs_", asy, "_by_times, times_index, "_", bsero, "_", trt, "_", ifelse(attr(config,"config")=="prevent19" & country=="Nvx_US", "US_only_", ""), study_name, ".pdf"))`}
