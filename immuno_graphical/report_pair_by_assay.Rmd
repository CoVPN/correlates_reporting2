...
\caption{`r paste0("Pair plots of ", if (study_name!="VAT08") paste0(gsub("B", "D1", gsub("ay", "", times_selected[[tm]])), collapse = " and "), ifelse(study_name=="VAT08", " and fold-change of ", " "), asyLabel, ": ", bseroLabel, " ", trt, " arm", ifelse(attr(config,"config")=="prevent19" & country=="Nvx_US", " (US only)", ""), immuno_postfix_label)`}
