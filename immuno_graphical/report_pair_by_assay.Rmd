...
\caption{`r paste0("Pair plots of D1", if (study_name!="VAT08") paste0(", D",timepoints, collapse = " and "), ifelse(study_name=="VAT08", " and fold-change of ", " "), asyLabel, ": ", bseroLabel, " ", trt, " arm", ifelse(study_name=="PREVENT19" & country=="Nvx_US", " (US only)", ""))`}
