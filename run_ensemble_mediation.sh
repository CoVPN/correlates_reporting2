...
do
    sbatch --export=TRIAL=${TRIAL} \
           --wrap="cd cop_mediation && Rscript code/cor_coxph.R D29IncludeNotMolecConfirmed"
    sbatch --export=TRIAL=${TRIAL} \
           --wrap="cd cop_mediation && Rscript code/cor_coxph.R D29SevereIncludeNotMolecConfirmed"
done
