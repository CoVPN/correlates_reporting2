...
setwd("/Users/larsvanderlaan/correlates_reporting_forks/correlates_reporting2")
library(here)
library(dplyr)
print(here::here())
...
if(tolower(study_name) %in% c("janssen_pooled_mock", "janssen_pooled_real", "janssen_na_mock", "janssen_na_real", "janssen_la_mock", "janssen_la_real", "janssen_sa_mock", 'janssen_sa_real')) {
  ENSEMBLE <- TRUE
  keys <-  c("Day29", "Day29Day1") 
}
...
if(tolower(study_name) %in% c("moderna_mock", 
"moderna_real")) {
  keys <- c("Day29", "Day57") 
}
