...
for (stage in c(2)){
  ...
  for (marker in names(spike_marker_list)){
    ...
    #           file = sprintf("output/Stage %s %s vaccine raw results.csv", stage, marker), 
    #           row.names = F)
    # 
    ...
    # write.csv(res$raw_table, 
    #           file = sprintf("output/Stage %s %s placebo raw results.csv", stage, marker), 
    #           row.names = F)
    ...
    # write.csv(res$raw_table, 
    #           file = sprintf("output/Stage %s %s vaccine change raw results.csv", stage, marker), 
    #           row.names = F)
