...
analysis_data_files <- c(
  ...
  HVTN705 = "HVTN705_secondcasecontrolprocesseddata_v14.csv",
  HVTN505 = "controlledVEdata505_lab.csv",
  RV144 = "controlledVEdataRV144_v2.csv"
)
```
...
regardless of whether the marker was sampled. Note: For HVTN705, there are 210 placebo participants missing their event/censoring time variable. These are excluded when calculating the placebo risk. 
* Vaccine efficacy confidence intervals cutoffs between -1 and 1. 
* EDIT 11/19: Subtracted HVTN 705 IgG markers by log10(2)
...
print_analysis_helper <- function(df, 
  ...
  data.frame(res_vaccine) %>%
      ...
      mutate(Threshold = 10^Thresholdlog10) %>% 
      rename(`Threshold (log10)` = Thresholdlog10) %>% 
      select(`Threshold (log10)`, rcdf, n_in_bin, n_events_in_bin, person_time_in_bin,
...
### IgG V1V2 B.CaseA-gp70, 169K only {.tabset .tabset-fade} 

```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "Delta.D210.is.169K"
marker_var <- "Day210IgGgp70.B.CaseA.V1.V250delta"

# excluding 3 people with missing sequence data 
print_analysis_helper(df_hvtn705 %>% 
                        filter(!is.na(Delta.D210.is.169K)), 
                      covariates = covariates, 
                      trt_var = trt_var, 
                      time_var = time_var,
                      event_var = event_var,
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG V1V2 B.CaseA-gp70, 169K only")
```

### IgG V1V2/B.CaseA2-gp70, non-169K only {.tabset .tabset-fade} 

```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "Delta.D210.not.169K"
marker_var <- "Day210IgGgp70.B.CaseA.V1.V250delta"

print_analysis_helper(df_hvtn705 %>% 
                        filter(!is.na(Delta.D210.not.169K)), 
                      covariates = covariates, 
                      trt_var = trt_var, 
                      time_var = time_var,
                      event_var = event_var,
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG V1V2 B.CaseA-gp70, non-169K only")
```
...
### IgG V1V2/B.CaseA2-gp70, 169K only {.tabset .tabset-fade} 

```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "HIVwk26.is.169K"
marker_var <- "IgG_gp70_B.CaseA_V1V2"

print_analysis_helper(df_rv144 %>% 
                        filter(!is.na(HIVwk26.is.169K)), 
                      covariates = covariates, 
                      trt_var = trt_var, 
                      time_var = time_var,
                      event_var = event_var,
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG V1V2/B.CaseA2-gp70, 169K only")
```

### IgG V1V2/B.CaseA2-gp70, non-169K only {.tabset .tabset-fade} 

```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "HIVwk26.not.169K"
marker_var <- "IgG_gp70_B.CaseA_V1V2"
...
print_analysis_helper(df_rv144 %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG V1V2/B.CaseA2-gp70, non-169K only")
```

### IgG gp70_BCaseA2V1V2169K, 169K only {.tabset .tabset-fade} 

```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "HIVwk26.is.169K"
marker_var <- "IgG_gp70BCaseA2V1V2169K"
...
print_analysis_helper(df_rv144 %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG gp70_BCaseA2V1V2169K, 169K only")
```

### IgG gp70_BCaseA2V1V2169K, non-169K only {.tabset .tabset-fade} 
...
print_analysis_helper(df_rv144 %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG gp70_BCaseA2V1V2169K, non-169K only")
```
...
```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "HIVm42.is.169K"
marker_var <- "IgG_gp70_B.CaseA_V1V2"

print_analysis_helper(df_rv144 %>% 
                        filter(!is.na(HIVm42.is.169K)), 
                      covariates = covariates, 
                      trt_var = trt_var, 
                      time_var = time_var,
                      event_var = event_var,
...
### CM244, 169K only {.tabset .tabset-fade} 

```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "HIVm42.is.169K"
marker_var <- "IgG_AE.A244_V1V2_Tags_293F"
...
print_analysis_helper(df_rv144 %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "CM244, 169K only")
```

### CM244, non-169K only {.tabset .tabset-fade} 
...
print_analysis_helper(df_rv144 %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "CM244, non-169K only")
```

### 1086tags, 169K only {.tabset .tabset-fade} 

```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "HIVm42.is.169K"
marker_var <- "IgG_C.1086C_V1V2_Tags"
...
print_analysis_helper(df_rv144 %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "1086tags, 169K only")
```

### 1086tags, non-169K only {.tabset .tabset-fade} 
...
print_analysis_helper(df_rv144 %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "1086tags, non-169K only")
```


### 1086gp70, 169K only {.tabset .tabset-fade} 

```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "HIVm42.is.169K"
marker_var <- "IgG_gp70_C.1086C_V1V2_293F"
...
print_analysis_helper(df_rv144 %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "1086gp70, 169K only")
```

### 1086gp70, non-169K only {.tabset .tabset-fade} 
...
print_analysis_helper(df_rv144 %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "1086gp70, non-169K only")
```
...
### IgG A244, 169K only {.tabset .tabset-fade} 
...
print_analysis_helper(df_combined %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG A244, 169K only")
```

### IgG A244, non-169K only {.tabset .tabset-fade} 
...
print_analysis_helper(df_combined %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG A244, non-169K only")
```


### IgG3 V1V2/B.CaseA2-gp70, 169K only {.tabset .tabset-fade} 

```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "HIVwk26.is.169K"
marker_var <- "IgG3_gp70_B.CaseA_V1V2"
...
print_analysis_helper(df_combined %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG3 V1V2/B.CaseA2-gp70, 169K only")
```

### IgG3 V1V2/B.CaseA2-gp70, non-169K only {.tabset .tabset-fade} 
...
print_analysis_helper(df_combined %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG3 V1V2/B.CaseA2-gp70, non-169K only")
```

### IgG3 A244, 169K only {.tabset .tabset-fade} 

```{r, results = "asis", cache=T, fig.align='center'}
event_var <- "HIVwk26.is.169K"
marker_var <- "IgG3_AE.A244_V1V2_Tags_293F"
...
print_analysis_helper(df_combined %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG3 A244, 169K only")
```

### IgG3 A244, non-169K only {.tabset .tabset-fade} 
...
print_analysis_helper(df_combined %>% 
                      ...
                      weight_var = weight_var, 
                      tf = tf, 
                      readable_name = "IgG3 A244, non-169K only")
```
