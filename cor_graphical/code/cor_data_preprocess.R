  ...
  dat <- dat %>%
    mutate(cohort_event = factor(
      case_when(Perprotocol==1 & (!!as.name(paste0("EarlyinfectionD", tinterm)))==0 & 
                  ...
                  (!!as.name(paste0("EventIndOmicronD", tinterm, "M6hotdeck1")))==1 & 
                  (!!as.name(paste0("EventTimeOmicronD", tinterm, "M6hotdeck1"))) >= 7 &
                  (!!as.name(paste0("EventTimeOmicronD", tpeak, "M6hotdeck1"))) < 7 ~ "7-27 days PD2 cases",
                Perprotocol==1 & (!!as.name(paste0("EarlyinfectionD", tpeak)))==0 & 
                  (ph2.D22.bAb==1 | ph2.D22.nAb==1 | ph2.D43.nAb==1 | ph2.D43.bAb==1) & 
                  (!!as.name(paste0("EventIndOmicronD", tpeak, "M6hotdeck1")))==1 &
                  (!!as.name(paste0("EventTimeOmicronD", tpeak, "M6hotdeck1"))) >= 7 &
                  (!!as.name(paste0("EventTimeOmicronD", tinterm, "M6hotdeck1"))) <= 180 ~ "28-180 days PD2 cases", 
                #Perprotocol==1 & (!!as.name(paste0("EarlyinfectionD", tpeak)))==0 & 
                ...
                Perprotocol==1 & (!!as.name(paste0("EarlyinfectionD", tpeak)))==0 & 
                  (ph2.D22.bAb==1 | ph2.D22.nAb==1 | ph2.D43.nAb | ph2.D43.bAb) & 
                  EventIndOmicronD22M6hotdeck1==0 ~ "Non-Cases"),
