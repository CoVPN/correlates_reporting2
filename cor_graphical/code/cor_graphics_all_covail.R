...
for (i in 1:length(set1_times)){
    ...
    file_name <- paste0("ms_",panel, "_6_strain_by_case_non_case_at_", set1_times[i]," (13 one-dose mRNA booster arms pooled naive vs. non-naive)", ".pdf")
