...
#} else {
  ...
  if (study_name=="VaxArt_Mock") COR_postfix_list <- c("D31toM12_VaxArt_Mock_sera")
  ...
  } else if (study_name == "VAT08" | attr(config,"config") %in% c("prevent19_stage2","azd1222_stage2","nvx_uk302","prevent19nvx", "VaxArt_Mock", "iliad_ib202p")){
...
cat("\\clearpage", sep = '\n')
      ...
      if (attr(config,"config") == "VaxArt_Mock") next # break the loop for VaxArt_Mock
